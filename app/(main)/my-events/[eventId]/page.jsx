  ...
  return (
    <div className="min-h-screen pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {event.coverImage && (
          <div className="relative h-[350px] rounded-2xl overflow-hidden mb-6" style={{ height: "350px" }}>
            <Image
        ...
        {stats.isEventToday && !stats.isEventPast && (
          <Button
            size="lg"
            //variant="ghost"
            className="mb-8 w-full gap-2 h-10 bg-linear-to-r from-orange-500 via-pink-500 to-red-500 text-gray-600 hover:scale-[1.02]"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 mt-6">
            ...
            <CardContent className="p-6 flex items-center gap-3">
              <div  className="p-3  rounded-lg" style={{ backgroundColor: "purple" }}>
          ...
          <Card className="py-0">
            <CardContent className="p-6 flex items-center gap-3">
              <div style={{ backgroundColor: "green" }} className="p-3 rounded-lg">
          ...
          {event.ticketType === "paid" ? (
            <Card className="py-0">
              <CardContent className="p-6 flex items-center gap-3">
                <div style={{ backgroundColor: "blue" }} className="p-3 rounded-lg">
            ...
            <Card className="py-0">
              <CardContent className="p-6 flex items-center gap-3">
                <div style={{ backgroundColor: "orange" }} className="p-3 rounded-lg">
                  <TrendingUp className="w-6 h-6 " />
                </div>
                <div>
          ...
          <Card className="py-0">
            <CardContent className="p-6 flex items-center gap-3">
              <div style={{ backgroundColor: "brown" }} className="p-3 rounded-lg">
